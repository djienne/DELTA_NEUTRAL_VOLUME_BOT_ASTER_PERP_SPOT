...
> ⚠️ I put the ``fee_coverage_multiplier` in `config_volume_farming_strategy.json` to `0.2` that is a bit agressive to make more turnowver and volume for the airdrop.
